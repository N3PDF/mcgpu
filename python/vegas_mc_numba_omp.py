...
@nb.njit(nb.types.Tuple((nb.float64, nb.float64[:]))(nb.int64, nb.float64[:,:], nb.int64[:]))
def generate_random_array(n_dim, divisions, div_index):
    """
...
if __name__ == '__main__':
    ...
    print(f'VEGAS MC numba, ncalls={ncalls},'
          f'threads={nb.config.NUMBA_DEFAULT_NUM_THREADS}:')
    start = time.time()
