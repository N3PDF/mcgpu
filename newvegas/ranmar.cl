#define STATE_RNG ranmar_state_t
#define RGN_INITIALIZER ranmar_set 
#define GEN_RAN ranmar_get_double 
...
ranmar_get (ranmar_state_t *state)
{
...
static double
ranmar_get_double (ranmar_state_t *vstate)
{
  return ranmar_get (vstate) / 16777216.0 ;
}

static void
ranmar_set (ranmar_state_t *state, ulong dummy, unsigned long int s)
{
